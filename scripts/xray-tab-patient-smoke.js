...
(async function main() {
    ...
    pass('build stamp bumped',
        /BUILD = '20260925notes5'/.test(idxSrc));
    ...
    for (var pi = 0; pi < ports.length; pi++) {
        try {
            ...
            var isOurs = probe.body.indexOf("BUILD = '20260925notes5'") >= 0;
    ...
    if (live) {
        ...
        pass('served build is 20260925notes5', build === '20260925notes5', build || 'missing');
        var xrayJs = await httpGet('127.0.0.1', livePort, '/app-xray.js?b=20260925notes5');
        var conJs = await httpGet('127.0.0.1', livePort, '/app-consultation.js?b=20260925notes5');
