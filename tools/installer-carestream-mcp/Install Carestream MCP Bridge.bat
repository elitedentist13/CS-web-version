...
echo.
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0install-xray-bridge.ps1" -InstallPath "C:\BananaBridge-Carestream-MCP" -ShortcutName "Joyful Smile Carestream MCP Bridge.lnk" -EnabledSystems "carestream,trophy"
echo.
