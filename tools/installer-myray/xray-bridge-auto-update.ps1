...
#       -InstallPath "C:\NNT" -Port 17890 -EnabledSystems "nntnewtom","myray" `
#       -ShortcutName "Joyful Smile NNT-NEWTOM Bridge.lnk" -PackageFolder "installer-myray"
#
param(
    [string]$InstallPath = "C:\NNT",
    [int]$Port = 17890,
    [string[]]$EnabledSystems = @("nntnewtom", "myray"),
    [string]$ShortcutName = "Joyful Smile NNT-NEWTOM Bridge.lnk",
    ...
    [string]$PackageFolder = "installer-myray",
    ...
    [string[]]$CompanionScripts = @("_nnt_identity_guard.ps1", "_nnt_new_opg_watcher.ps1")
)
