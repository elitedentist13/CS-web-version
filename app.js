...
function applyAppScrollState(state) {
    ...
    try {
        ...
        Object.keys(state.els).forEach(function(key) {
            ...
            if (sel.indexOf('plusappt-schedule-wrap') >= 0 ||
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    wireToolCard('pdf-editor', function() {
        if (typeof PDFEDITOR !== 'undefined' && typeof PDFEDITOR.open === 'function') PDFEDITOR.open();
    });
...
function applyOpenGlobalModalsI18n() {
    ...
    var ids = [
        ...
        'billDetailModal', 'receiptModal', 'receiptPrintOptionsModal', 'billHistoryPrintModal', 'addPaymentModal', 'balanceTransferConfirmModal', 'patientDupClinicModal', 'billPaymentClinicConfirmModal', 'billDeleteModal',
