...
(async function main() {
    ...
    if (live) {
        ...
        pass('served build is 20260922xraytab1', build === '20260922xraytab1', build || 'missing');
        var xrayJs = await httpGet('127.0.0.1', 5500, '/app-xray.js?b=20260922xraytab1');
        var conJs = await httpGet('127.0.0.1', 5500, '/app-consultation.js?b=20260922xraytab1');
